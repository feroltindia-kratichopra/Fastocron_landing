    ...
    <section className="border-t border-slate-200 bg-white py-24">
      <div className="mx-auto max-w-6xl px-6">
        <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
          ...
          <div
            ref={ref}
            className="relative flex min-h-[260px] items-center justify-center rounded-3xl border border-slate-200 bg-slate-950 p-8 font-mono text-[11px] text-sky-100"
          >
            <div className="absolute left-4 top-4 rounded-lg border border-slate-700 bg-slate-900 px-3 py-2 text-[10px] text-slate-400">
              POST /hooks/incoming
            </div>
            <motion.div
            ...
            >
              <span className="text-emerald-300">connector</span>
              <span className="text-slate-500"> :: </span>
              <span className="text-sky-300">snap()</span>
            </motion.div>
          </div>
        </div>
      </div>
