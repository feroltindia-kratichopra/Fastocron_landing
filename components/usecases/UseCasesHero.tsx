...
export default function UseCasesHero() {
  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-b from-white via-slate-50 to-white pb-20 pt-28 text-slate-900 lg:pt-32">
      {!reduce && (
      ...
      <div className="relative z-10 mx-auto grid max-w-7xl gap-10 px-4 sm:px-6 lg:grid-cols-[1fr_1.05fr] lg:items-center">
        ...
        <div>
          ...
          <h1 className="mt-5 text-3xl font-bold leading-tight tracking-tight text-slate-900 sm:text-5xl lg:text-[2.75rem]">
          ...
          <p className="mt-6 max-w-xl text-sm leading-relaxed text-slate-600 sm:text-lg">
        ...
        >
          ...
          <div className="relative w-full overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-2xl backdrop-blur">
            {/* TOP */}
                ...
                >
                  ...
                  <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                    <div className="flex items-center gap-3 sm:gap-4">
                      <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl bg-slate-100 sm:h-14 sm:w-14">
                        <CurrentIcon
                    ...
                    <div className="w-fit rounded-2xl border border-emerald-200 bg-emerald-50 px-4 py-2">
                  ...
                  <p className="mt-5 text-sm leading-6 text-slate-600 sm:leading-7">
                    {current.desc}
                  </p>
                  ...
                  {/* CHART */}
                  <div className="mt-5 rounded-2xl border border-slate-200 bg-slate-100 p-3 sm:p-4">
                    <div className="relative">
                      <div className="absolute inset-0 grid grid-rows-4">
                        {[1, 2, 3, 4].map((i) => (
                          <div key={i} className="border-t border-slate-200/80" />
                        ))}
                      </div>
