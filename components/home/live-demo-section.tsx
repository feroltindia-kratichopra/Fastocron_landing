...
export default function LiveDemoSection() {
  return (
    ...
    >
      <BlurOrbs />
      <div className="pointer-events-none absolute inset-0 bg-[linear-gradient(to_bottom,transparent,rgba(5,8,22,0.85))]" />
      ...
      <div
        className="pointer-events-none relative z-10 h-20 bg-gradient-to-b from-transparent via-[#0B1120]/40 to-white"
        aria-hidden
      />
    </section>
  );
